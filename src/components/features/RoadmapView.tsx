import { Card, CardHeader, CardTitle, LoadingSpinner } from '@/components/ui/Card';
    ...
    <div className="relative pl-8 pb-8 last:pb-0">
      ...
      <div className="brutal-border bg-white shadow-brutal p-4">
        ...
        <div className="space-y-2">
          <p className="text-xs font-bold text-brand-black uppercase tracking-wide">Resources</p>
